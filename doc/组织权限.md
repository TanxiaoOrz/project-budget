...
- 指定角色(根据选择角色相关等级和相对应用户的角色等级并且再同一个分部/部门下)
    ...
    body: {
        "character":[
            {
                "chactorId":1,
                "grade":"base/sectionRecursive/section/depart"
            },{},{}
        ],
        ...
    }
...
- 指定权限组
  ```json
    body: {
        "authority":[
            ["authority1","authority2","authority3"],     //小组内条件为与
            [],
            []
        ]   //大组内条件为或
    }
...
- 角色表单 character
    ...
    角色编号|characterId|Unsigned BigInt|primary Key
