...
@Mapper
public interface ColumnViewMapper extends BaseMapper<ColumnView> {
     ...
     * @return 字段显示最新值
     */
    @Select("select ifnull(max(columnViewNo),0)+1 from table_view_column_index where tableNo = #{tableNo}")
