...
public class FromEntityServiceImpl implements FormService<ColumnEntity, TableEntity> {
    ...
    @Override
    public FormOutDto<ColumnEntity, TableEntity> getFormOne(Long tableId, Long dataId, Long userId) {
        return null;
    }

    @Override
    public Integer updateForm(FormOutDto<ColumnEntity, TableEntity> formOutDto, Long userId) {
        return null;
    }

    @Override
    public Integer createForm(FormOutDto<ColumnEntity, TableEntity> formOutDto, Long userId) {
        return null;
    }
    ...
    @Override
    public List<FormOutDto<ColumnEntity, TableEntity>> getFormSort(Long tableId, FilterFormUtils filter, Long userId) {
        return null;
    }
